...
<div class="container table-responsiv">
  ...
  <tr>
   ...
   <td>
    <textarea rows="10" cols="60"  name="content"  id="i_content"  disabled />${article.content }</textarea>
   </td>  
  </tr>
 <%-- 
   ...
   <td colspan="2" align="center">
       <c:if test="${member.id == article.id }">
	    ...
	    <input type=button value="리스트로 돌아가기"  onClick="backToList()" class="btn btn-info">
	     <input type=button value="답글쓰기"  onClick="fn_reply_form('../replyForm', ${article.articleNO})" class="btn btn-info">
   </td>
  </tr>
 </table>
 </form>
